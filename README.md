...
<a href="https://pkg.go.dev/github.com/stainless-sdks/fragment-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/fragment-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Fragment Go library provides convenient access to the Fragment REST API
...
```go
import (
	"github.com/stainless-sdks/fragment-go" // imported as fragment
)
```
...
```sh
go get -u 'github.com/stainless-sdks/fragment-go@v0.0.1'
```
...
The fragment library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/fragment-go/option).
...
`*fragment.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `fragment.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/fragment-go/issues) with questions, bugs, or suggestions.
