...
// RequestOption is an option for the requests made by the fragment API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/fragment-dev/fragment-billing-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.us-west-2.fragment.dev/billing/")
}

// WithClientID returns a RequestOption that sets the client setting "client_id".
func WithClientID(value string) RequestOption {
	oauthState := requestconfig.OAuth2Cache["https://auth.us-west-2.fragment.dev/oauth2/token"]
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.ClientID = value
