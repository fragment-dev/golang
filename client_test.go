...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.ExternalAccounts.New(context.Background(), fragment.ExternalAccountNewParams{
		ExternalID: "ext_acc_123",
		Name:       "Checking Account",
	})
	if userAgent != fmt.Sprintf("Fragment/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.ExternalAccounts.New(context.Background(), fragment.ExternalAccountNewParams{
		ExternalID: "ext_acc_123",
		Name:       "Checking Account",
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.ExternalAccounts.New(cancelCtx, fragment.ExternalAccountNewParams{
		ExternalID: "ext_acc_123",
		Name:       "Checking Account",
	})
	if err == nil {
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.ExternalAccounts.New(deadlineCtx, fragment.ExternalAccountNewParams{
			ExternalID: "ext_acc_123",
			Name:       "Checking Account",
		})
		if err == nil {
