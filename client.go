...
// interacting with the fragment API. You should not instantiate this client
...
// DefaultClientOptions read from the environment (FRAGMENT_CLIENT_ID,
// FRAGMENT_CLIENT_SECRET, FRAGMENT_BASE_URL). This should be used to initialize
// new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithHTTPClient(defaultHTTPClient()), option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("FRAGMENT_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("FRAGMENT_CLIENT_ID"); ok {
		defaults = append(defaults, option.WithClientID(o))
	}
	if o, ok := os.LookupEnv("FRAGMENT_CLIENT_SECRET"); ok {
		defaults = append(defaults, option.WithClientSecret(o))
	}
	if o, ok := os.LookupEnv("FRAGMENT_CUSTOM_HEADERS"); ok {
...
// environment (FRAGMENT_CLIENT_ID, FRAGMENT_CLIENT_SECRET, FRAGMENT_BASE_URL). The
